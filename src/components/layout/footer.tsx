    ...
    <footer className="bg-[#211e1e] text-white">
      <div className="max-w-7xl mx-auto px-4 py-10 md:py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="font-semibold text-sm mb-3 uppercase tracking-wider text-blue-300">Quick Links</h4>
          ...
          <div>
            <h4 className="font-semibold text-sm mb-3 uppercase tracking-wider text-blue-300">Accounts</h4>
            <ul className="space-y-2 text-sm text-blue-200">
          ...
          <div>
            <h4 className="font-semibold text-sm mb-3 uppercase tracking-wider text-blue-300">Support</h4>
            <ul className="space-y-2 text-sm text-blue-200">
      ...
      <div className="border-t border-[#444]">
        <div className="max-w-7xl mx-auto px-4 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-blue-300">
