    ...
    <section className="py-12 sm:py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-10">
          <p className="text-green-600 text-sm font-medium mb-2"><T k="rates.eyebrow" /></p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-100 flex flex-col">
            ...
            <p className="text-2xl font-bold text-green-700 mb-1">2.49% <span className="text-base font-semibold">APR*</span> <span className="text-sm text-gray-500 font-normal"><T k="rates.heloc.term" /></span></p>
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-100 flex flex-col">
            <span className="mb-3 inline-flex w-fit rounded-full bg-green-100 px-3 py-1 text-xs font-bold text-green-700"><T k="promo.checking.eyebrow" /></span>
            ...
            <Button asChild variant="outline" className="mt-auto w-fit border-green-600 text-green-700 hover:bg-green-50">
