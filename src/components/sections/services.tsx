...
const services = [
  { titleKey: "offering.loans.title", descKey: "offering.loans.desc" },
  { titleKey: "offering.transfer.title", descKey: "offering.transfer.desc" },
  { titleKey: "offering.prepaid.title", descKey: "offering.prepaid.desc" },
  { titleKey: "offering.net.title", descKey: "offering.net.desc" },
  { titleKey: "offering.mcash.title", descKey: "offering.mcash.desc" },
];
