    ...
    <section id="services" className="py-12 sm:py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-10">
          <p className="text-blue-600 text-sm font-medium mb-2"><T k="services.eyebrow" /></p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {accounts.map((a) => (
            <div key={a.titleKey} className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-shadow border border-gray-100">
              ...
              <p className="text-blue-600 font-bold text-xl mb-4">{a.apr}</p>
        ...
        <div className="mt-14">
          <div className="text-center mb-8">
            <p className="text-blue-600 text-sm font-medium mb-2"><T k="services.eyebrow2" /></p>
            <h3 className="text-xl sm:text-2xl font-bold"><T k="services.heading2" /></h3>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {offerings.map((o) => (
              <Link key={o.titleKey} href={o.href} className="group block rounded-2xl overflow-hidden bg-white border border-gray-100 shadow-sm hover:shadow-lg hover:border-blue-300 transition-all">
