...
export const translations: Dict = {
  ...
  "promo.home.cta": { en: "View Mortgage Rates", es: "Ver tasas hipotecarias", fr: "Voir les taux hypothécaires", de: "Hypothekenzinsen ansehen", pt: "Ver taxas hipotecárias", zh: "查看房贷利率", ar: "عرض أسعار الرهن العقاري" },
